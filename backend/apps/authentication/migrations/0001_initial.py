    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Super Admin', 'Super Admin'), ('School Admin', 'School Admin'), ('Principal', 'Principal'), ('Vice Principal', 'Vice Principal'), ('Teacher', 'Teacher'), ('Student', 'Student'), ('Parent', 'Parent'), ('Accountant', 'Accountant'), ('HR Manager', 'HR Manager')], default='Student', max_length=20)),
